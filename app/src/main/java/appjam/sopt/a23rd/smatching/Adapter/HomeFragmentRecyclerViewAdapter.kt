...
class HomeFragmentRecyclerViewAdapter(val ctx: Context, val dataList: ArrayList<NoticeData>, val token : String) : RecyclerView.Adapter<HomeFragmentRecyclerViewAdapter.Holder>() {
